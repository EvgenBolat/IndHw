...
.text
	...
	inputArray(t0, t1) #first arg – Array size; second arg - pointer to Array
	print_str("\nArrayA: ")
	lw	t0, (sp)
	lw	t1, 4(sp)
	printArray(t0, t1) #first arg – Array size; second arg - pointer to Array
	lw	t0, 4(sp)
	lw	t1, (sp)
	...
	la	t0, arrayB
	print_str("\nArrayB: ")
	printArray(t2, t0) #first arg – Array size; second arg - pointer to Array
	addi	sp, sp, 20
	li	a7, 10
	ecall